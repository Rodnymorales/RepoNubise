...
{
	public abstract class RespuestaApp <T> : IEquatable<T> where T : RespuestaApp<T>
	{
		public Dictionary<string,Guid> Relaciones{ get; set; }


		protected RespuestaApp ()
		{
		...
		public static bool operator == (RespuestaApp<T> x, RespuestaApp<T> y)
		{
