...
{
    [TestFixture]
    public class AdministradorDeDiccionariosPruebas
    {
        ...
        [Test]
        [Category("Consultar Diccionarios")]
        public void DeberiaPoderObtenerUnErrorDeTipoArgumentNullExceptionCuandoNoExisteElRepositorio()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.When(x => x.ObtenerDiccionarios()).Do(obj => { throw new ArgumentNullException(); });

            var serviciosApi = new AdministradorDeDiccionarios(diccionarioRepositorio);

            Should.Throw<ArgumentNullException>(
                () => serviciosApi.ConsultarDiccionarios()
            );
        }

        [Test]
        [Category("Consultar Diccionarios")]
        public void DeberiaPoderObtenerUnErrorDeTipoInvalidOperationExceptionCuandoNoExistenDiccionariosEnElRepositorio()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.When(x => x.ObtenerDiccionarios()).Do(obj => { throw new InvalidOperationException(); });
        ...
        [Test]
        [Category("Consultar Diccionarios")]
        public void DeberiaPoderConsultarLosDiccionariosQueExistenEnElRepositorio()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.ObtenerDiccionarios().Returns(ListaConDosDiccionarios());

            var serviciosApi = new AdministradorDeDiccionarios(diccionarioRepositorio);

            var respuestaEsperada = RespuestaEsperadaConsultarDiccionarios();

            //Act
            var respuestaReal = serviciosApi.ConsultarDiccionarios();
        ...
        [Test]
        [Category("Consultar un diccionario")]
        public void DeberiaPoderObtenerUnErrorDeTipoExceptionCuandoNoExisteElDiccionarioSolicitadoEnElRepositorio()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.ObtenerUnDiccionario(diccionarioBaseId).Returns(DiccionarioBaseConCuatroEtiquetas());

            var peticion = ConsultarUnDiccionarioPeticion.CrearNuevaInstancia();
            ...
            Should.Throw<Exception>(
                () => serviciosApi.ConsultarUnDiccionario(peticion)
            );
        }

        [Test]
        [Category("Consultar un diccionario")]
        public void DeberiaPoderConsultarUnDiccionarioExistenteEnElRepositorio()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.ObtenerUnDiccionario(diccionarioAdicionalId).Returns(DiccionarioAdicionalConDosEtiquetas());
            ...
            var respuestaEsperada = RespuestaEsperadaConsultarUnDiccionario();

            //Act
            var respuestaReal = serviciosApi.ConsultarUnDiccionario(peticion);

            //Assert
            respuestaEsperada.ShouldSatisfyAllConditions(
                () => respuestaEsperada.Diccionario.ShouldBe(respuestaReal.Diccionario),
        ...
        #region ModificarUnDiccionario

        [Test]
        [Category("Modificar un diccionario")]
        public void DeberiaPoderObtenerUnErrorDeTipoNullReferenceExceptionCuandoNoSeEncontroElDiccionarioSolicitadoParaModificar()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            ...
            diccionarioRepositorio.SalvarUnDiccionario(diccionarioInicialDeLasPruebas).Returns(DiccionarioConElAmbienteModificado());

            var peticion = ModificarUnDiccionarioPeticion.CrearNuevaInstancia(string.Empty);
            peticion.Diccionario = Diccionario.CrearNuevoDiccionario(diccionarioAdicionalId, AmbienteModificado);

            var serviciosApi = new AdministradorDeDiccionarios(diccionarioRepositorio);

            //Act y Assert
            Should.Throw<NullReferenceException>(
                () => serviciosApi.ModificarUnDiccionario(peticion)
            );
        }

        [Test]
        [Category("Modificar un diccionario")]
        public void DeberiaPoderObtenerUnErrorSiAlSalvarElDiccionarioModificadoSeRetornaNull()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            var diccionarioInicialDeLasPruebas = DiccionarioBaseConDosEtiquetas();
            ...
            var peticion = ModificarUnDiccionarioPeticion.CrearNuevaInstancia(string.Empty);
            peticion.Diccionario = Diccionario.CrearNuevoDiccionario(diccionarioBaseId, AmbienteModificado);
        ...
        [Test]
        [Category("Modificar un diccionario")]
        public void DeberiaPoderModificarUnDiccionarioExistente()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            var diccionarioInicialDeLasPruebas = DiccionarioBaseConDosEtiquetas();
            ...
            var respuestaEsperada = RespuestaEsperadaModificarUnDiccionario();

            //Act
            var respuestaReal = serviciosApi.ModificarUnDiccionario(peticion);
        ...
        #region EliminarUnDiccionario

        [Test]
        [Category("Eliminar un diccionario")]
        public void DeberiaPoderObtenerUnErrorSiOcurreUnaFallaEliminadoElDiccionario()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            diccionarioRepositorio.When(x => x.EliminarUnDiccionario(diccionarioBaseId)).Do(obj => { throw new Exception(); });

            var peticion = EliminarUnDiccionarioPeticion.CrearNuevaInstancia();
            ...
            //Act y Arrange
            Should.Throw<Exception>(
                () => serviciosApi.EliminarUnDiccionario(peticion)
            );
        }

        [Test]
        [Category("Eliminar un diccionario")]
        public void DeberiaPoderObtenerUnErrorSiAlSalvarElDiccionarioEliminadoSeRetornaNull()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            var diccionariosNull = new List<Diccionario> { Diccionario.CrearNuevoDiccionario(String.Empty) };
            var listaDeDiccionarios = new List<Diccionario> { DiccionarioAdicionalConDosEtiquetas() };
            diccionariosNull = null;
            diccionarioRepositorio.EliminarUnDiccionario(diccionarioBaseId).Returns(listaDeDiccionarios);
            diccionarioRepositorio.SalvarDiccionarios(listaDeDiccionarios).Returns(diccionariosNull);
        ...
        [Test]
        [Category("Eliminar un diccionario")]
        public void DeberiaPoderEliminarUnDiccionarioExistente()
        {
            //Arrange
            var diccionarioRepositorio = Substitute.For<IDiccionarioRepositorio>();
            var listaDeDiccionarios = new List<Diccionario> { DiccionarioAdicionalConDosEtiquetas() };
            diccionarioRepositorio.EliminarUnDiccionario(diccionarioBaseId).Returns(listaDeDiccionarios);
            diccionarioRepositorio.SalvarDiccionarios(listaDeDiccionarios).Returns(listaDeDiccionarios);
            ...
            var respuestaEsperada = RespuestaEsperadaEliminarUnDiccionario();

            //Act
            var respuestaReal = serviciosApi.EliminarUnDiccionario(peticion);
